  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16 }}>
      <div className="panel" style={{ textAlign: 'center', maxWidth: 420, padding: 36 }}>
        <div style={{ width: 56, height: 56, borderRadius: 16, background: 'rgba(56, 189, 248, 0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px' }}>
          <FileQuestion size={28} className="text-sky-400" />
        </div>
